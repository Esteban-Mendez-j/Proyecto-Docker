...
export function ListSvg({ name, width, height, nameClass="icon" }) {
  ...
  const listSVG = {
    ...
    campana:(
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width={width} height={height} fill="currentColor" className={nameClass}>
    ...
    prediccion:(
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={width} height={height} fill="currentColor" className={nameClass}>
